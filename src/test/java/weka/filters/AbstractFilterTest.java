...
public abstract class AbstractFilterTest
  ...
  // TODO: 
    ...
    /**
     * Configures the CheckGOE used for testing GOE stuff. Sets the Filter
     ...
     *
     * Where the first three attributes do not contain any missing values, but
     * the last three attributes do. If the filter is for some reason incapable
     * of accepting a dataset of this type, override setUp() to either
     * manipulate the default dataset to be compatible, or load another test
     * dataset.
     * <p>
     *
     * The configured filter should preferrably do something meaningful, since
     * the results of filtering are used as the default regression output (and
     * it would hardly be interesting if the filtered data was the same as the
     * input data).
     *
     ...
     *
     * @return the Instances after filtering through the filter we have set up
     * to test.
     */
    ...
    /**
     * Test incremental operation. Each instance is removed as soon as it is
     * made available
     */
